...
function calendarJs( id, options, searchOptions, startDateTime ) {
    ...
    function runBrowserNotificationAction( action, writeConsoleLog ) {
        if ( _options.eventNotificationsEnabled && !_datePickerModeEnabled ) {
            ...
            if ( !Notification ) {
                if ( writeConsoleLog ) {
                    console.error( "Notificações do navegador API indisponíveis." );
                }
            } else {
                action();
            }
    ...
    function buildDefaultOptions( newOptions ) {
        ...
        if ( !isDefinedString( _options.defaultEventBorderColor ) ) {
            _options.defaultEventBorderColor = "#FFD500";
        }
    ...
    function setTranslationStringOptions() {
        ...
        if ( !isDefinedString( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Adicionar evento";
        }
        ...
        if ( !isDefinedString( _options.listAllEventsTooltipText ) ) {
            _options.listAllEventsTooltipText = "Mostar todos os eventos";
        }

        if ( !isDefinedString( _options.listWeekEventsTooltipText ) ) {
            _options.listWeekEventsTooltipText = "Mostrar eventos da semana atual";
        }
        ...
        if ( !isDefinedString( _options.isAllDayText ) ) {
            _options.isAllDayText = "O dia todo";
        }
        ...
        if ( !isDefinedString( _options.locationText ) ) {
            _options.locationText = "Localização:";
        }
        ...
        if ( !isDefinedString( _options.addEventTitle ) ) {
            _options.addEventTitle = "Adicionar Lembrete";
        }
        ...
        if ( !isDefinedString( _options.exportStartFilename ) ) {
            _options.exportStartFilename = "eventos_exportados_";
        }

        if ( !isDefinedString( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Por favor, selecione um tempo 'De' válido.";
        }

        if ( !isDefinedString( _options.toTimeErrorMessage ) ) {
            _options.toTimeErrorMessage = "Por favor, selecione uma hora 'Para' válida.";
        }

        if ( !isDefinedString( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Favor selecionar uma data 'Até' maior que a data 'De'.";
        }

        if ( !isDefinedString( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "Favor inserir um valor no campo 'Título' (sem espaço em branco).";
        }
        ...
        if ( !isDefinedString( _options.allDayText ) ) {
            _options.allDayText = "Todo o dia";
        }

        if ( !isDefinedString( _options.allEventsText ) ) {
            _options.allEventsText = "Todos eventos";
        }

        if ( !isDefinedString( _options.toTimeText ) ) {
            _options.toTimeText = "para";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirmar remoção do evento";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "A remoção deste evento não pode ser desfeita.  Você quer continuar?";
        }
        
        if ( !isDefinedString( _options.okText ) ) {
            _options.okText = "Salvar";
        }
        
        if ( !isDefinedString( _options.selectExportTypeTitle ) ) {
            _options.selectExportTypeTitle = "Opções de exportação";
        }
        
        if ( !isDefinedString( _options.selectColorsText ) ) {
            _options.selectColorsText = "Selecionar cores";
        }
        ...
        if ( !isDefinedString( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "Procurar eventos";
        }
        
        if ( !isDefinedString( _options.previousText ) ) {
            _options.previousText = "Prévio";
        }
        ...
        if ( !isDefinedString( _options.matchCaseText ) ) {
            _options.matchCaseText = "Combinações";
        }
        ...
        if ( !isDefinedString( _options.repeatDaysToExcludeText ) ) {
            _options.repeatDaysToExcludeText = "Repetir dias para excluir:";
        }
        ...
        if ( !isDefinedString( _options.seriesIgnoreDatesText ) ) {
            _options.seriesIgnoreDatesText = "Ignorar datas:";
        }
        ...
        if ( !isDefinedString( _options.repeatsEveryDayText ) ) {
            _options.repeatsEveryDayText = "Diariamente";
        }
        
        if ( !isDefinedString( _options.repeatsEveryWeekText ) ) {
            _options.repeatsEveryWeekText = "Semanalmente";
        }

        if ( !isDefinedString( _options.repeatsEvery2WeeksText ) ) {
            _options.repeatsEvery2WeeksText = "A cada 2 semanas";
        }
        
        if ( !isDefinedString( _options.repeatsEveryMonthText ) ) {
            _options.repeatsEveryMonthText = "Mensalmente";
        }
        
        if ( !isDefinedString( _options.repeatsEveryYearText ) ) {
            _options.repeatsEveryYearText = "Anualmente";
        }
        ...
        if ( !isDefinedString( _options.repeatOptionsTitle ) ) {
            _options.repeatOptionsTitle = "Opções de repetição";
        }
        ...
        if ( !isDefinedString( _options.removeAllEventsInSeriesText ) ) {
            _options.removeAllEventsInSeriesText = "Remover todos os eventos em série";
        }
        
        if ( !isDefinedString( _options.createdText ) ) {
            _options.createdText = "Criado:";
        }
        ...
        if ( !isDefinedString( _options.organizerEmailAddressText ) ) {
            _options.organizerEmailAddressText = "Organizador email:";
        }
        
        if ( !isDefinedString( _options.enableFullScreenTooltipText ) ) {
            _options.enableFullScreenTooltipText = "Ligar modo tela cheia";
        }
        
        if ( !isDefinedString( _options.disableFullScreenTooltipText ) ) {
            _options.disableFullScreenTooltipText = "Desligar modo tela cheia";
        }
        ...
        if ( !isDefinedString( _options.expandMonthTooltipText ) ) {
            _options.expandMonthTooltipText = "Expandir mês";
        }
        
        if ( !isDefinedString( _options.repeatEndsText ) ) {
            _options.repeatEndsText = "Terminar repetição";
        }
        
        if ( !isDefinedString( _options.noEventsAvailableText ) ) {
            _options.noEventsAvailableText = "Sem eventos disponíveis.";
        }
        
        if ( !isDefinedString( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "Mostrar eventos da semana";
        }
        
        if ( !isDefinedString( _options.noEventsAvailableFullText ) ) {
            _options.noEventsAvailableFullText = "Não há eventos disponíveis para visualizar.";
        }
        ...
        if ( !isDefinedString( _options.toAddANewEventText ) ) {
            _options.toAddANewEventText = "para adicionar novo evento.";
        }
        ...
        if ( !isDefinedString( _options.eventNotificationTitle ) ) {
            _options.eventNotificationTitle = "Calendario";
        }
        
        if ( !isDefinedString( _options.eventNotificationBody ) ) {
            _options.eventNotificationBody = "O evento '{0}' começou.";
        }

        if ( !isDefinedString( _options.optionsText ) ) {
            _options.optionsText = "Opções";
        }

        if ( !isDefinedString( _options.startsWithText ) ) {
            _options.startsWithText = "Começar em";
        }

        if ( !isDefinedString( _options.endsWithText ) ) {
            _options.endsWithText = "Terminar em";
        }

        if ( !isDefinedString( _options.containsText ) ) {
            _options.containsText = "Contém";
        }

        if ( !isDefinedString( _options.displayTabText ) ) {
            _options.displayTabText = "Mostrar";
        }
        
        if ( !isDefinedString( _options.enableAutoRefreshForEventsText ) ) {
            _options.enableAutoRefreshForEventsText = "Habilitar atualização automática para eventos";
        }

        if ( !isDefinedString( _options.enableBrowserNotificationsText ) ) {
            _options.enableBrowserNotificationsText = "Habilitar notificação do navegador";
        }

        if ( !isDefinedString( _options.enableTooltipsText ) ) {
            _options.enableTooltipsText = "Habilitar pontas de ferramentas";
        }

        if ( !isDefinedString( _options.dayText ) ) {
            _options.dayText = "dia";
        }

        if ( !isDefinedString( _options.daysText ) ) {
            _options.daysText = "dias";
        }
        ...
        if ( !isDefinedString( _options.enableDragAndDropForEventText ) ) {
            _options.enableDragAndDropForEventText = "Permitir arrastar e soltar para eventos";
        }

        if ( !isDefinedString( _options.organizerTabText ) ) {
            _options.organizerTabText = "Organizar";
        }

        if ( !isDefinedString( _options.removeEventsTooltipText ) ) {
            _options.removeEventsTooltipText = "Remover eventos";
        }

        if ( !isDefinedString( _options.confirmEventsRemoveTitle ) ) {
            _options.confirmEventsRemoveTitle = "Confirmar remoção de eventos";
        }
        
        if ( !isDefinedString( _options.confirmEventsRemoveMessage ) ) {
            _options.confirmEventsRemoveMessage = "A remoção destes eventos não repetitivos não pode ser desfeita.  Você quer continuar?";
        }
        ...
        if ( !isDefinedString( _options.visibleDaysTabText ) ) {
            _options.visibleDaysTabText = "Dias visíveis";
        }

        if ( !isDefinedString( _options.enableDayNameHeadersInMainDisplayText ) ) {
            _options.enableDayNameHeadersInMainDisplayText = "Habilitar cabeçalhos de nome do dia no display principal";
        }

        if ( !isDefinedString( _options.thisWeekTooltipText ) ) {
            _options.thisWeekTooltipText = "Essa semana";
        }

        if ( !isDefinedString( _options.dailyText ) ) {
            _options.dailyText = "Diariamente";
        }

        if ( !isDefinedString( _options.weeklyText ) ) {
            _options.weeklyText = "Semanalmente";
        }

        if ( !isDefinedString( _options.monthlyText ) ) {
            _options.monthlyText = "Mensalmente";
        }

        if ( !isDefinedString( _options.yearlyText ) ) {
            _options.yearlyText = "Anualmente";
        }

        if ( !isDefinedString( _options.repeatsByCustomSettingsText ) ) {
            _options.repeatsByCustomSettingsText = "Configurações personalizadas";
        }

        if ( !isDefinedString( _options.lastUpdatedText ) ) {
            _options.lastUpdatedText = "Última atualização";
        }

        if ( !isDefinedString( _options.advancedText ) ) {
            _options.advancedText = "Avançado";
        }
        ...
        if ( !isDefinedString( _options.showAlertsText ) ) {
            _options.showAlertsText = "Aparecer alertas";
        }

        if ( !isDefinedString( _options.selectDatePlaceholderText ) ) {
            _options.selectDatePlaceholderText = "Escolha a data";
        }

        if ( !isDefinedString( _options.hideDayText ) ) {
            _options.hideDayText = "Esconder dia";
        }

        if ( !isDefinedString( _options.notSearchText ) ) {
            _options.notSearchText = "Não (oposto)";
        }

        if ( !isDefinedString( _options.showEmptyDaysInWeekViewText ) ) {
            _options.showEmptyDaysInWeekViewText = "Mostrar dias livres da semana";
        }

        if ( !isDefinedString( _options.showHolidaysInTheDisplaysText ) ) {
            _options.showHolidaysInTheDisplaysText = "Mostrar feriados na tela principal";
        }

        if ( !isDefinedString( _options.newEventDefaultTitle ) ) {
            _options.newEventDefaultTitle = "* Novo evento";
        }

        if ( !isDefinedString( _options.urlErrorMessage ) ) {
            _options.urlErrorMessage = "Por favor coloque uma URL válida no campo 'URL' (ou deixe em branco).";
        }
        ...
        if ( !isDefinedString( _options.searchTextBoxPlaceholder ) ) {
            _options.searchTextBoxPlaceholder = "Procurar título, descrição, etc...";
        }
    }
    ...
    function getOptions( newOptions ) {
        if ( !isDefined( newOptions ) || typeof newOptions !== "objeto" ) {
            newOptions = {};
        }
